...
# BIOS INSTALL - aqui está a modificação principal
read -p "Dispositivo de disco para instalação do GRUB (ex.: /dev/sda): " grub_disk
echo "Installing grub in modo BIOS..."
